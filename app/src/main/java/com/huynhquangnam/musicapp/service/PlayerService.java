...
public class PlayerService extends Service {
    ...
    private void showNotification() {
        ...
        Notification notification = new NotificationCompat.Builder(this)
                ...
                .addAction(R.drawable.ic_pause_black_48dp, null, changeStatusIntent)
                .addAction(R.drawable.ic_close_black_48dp, null, stopAudio)
                .setSmallIcon(R.drawable.ic_logo_app).build();
